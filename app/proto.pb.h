...
#define EPB_PAYLOAD_MAX_LEN		1031//1024 	//chen 
...
typedef enum{  //2019/06/03
	
	HUB_KEY_XYZ_READ = 0x01,
	HUB_KEY_STEP_COUNT_READ, 
	HUB_KEY_STATE, 
    HUB_KEY_INFO = 0x08,
    HUB_KEY_INT_ENABLE=0x10,
    HUB_KEY_UTC_UPDATE,
    HUB_KEY_LED_CTRL,
    HUB_KEY_MOTION_ALERT =0X52,
    HUB_KEY_NOMOTION_ALERT,
    HUB_KEY_TILT_ALERT =0X55,
    HUB_KEY_FALL_DOWN_ALERT,
    HUB_KEY_MSG_READ=0XF0
    
}epb_key_of_sensor_hub_t;
