...
#define ALERT_MOTION_SETUP_TIME_MIN		10 
#define ALERT_MOTION_SETUP_TIME_MAX 	(10 * 60 ) // 10 minutes 
#define ALERT_MOTION_ACTION_TIME_MIN	10 
#define ALERT_MOTION_ACTION_TIME_MAX 	(10 * 60 ) // 

#define ALERT_STATIC_DATA_SIZE 			4 
#define ALERT_STATIC_THRESHOLD_MIN		3 
#define ALERT_STATIC_THRESHOLD_MAX		(30*60) 
